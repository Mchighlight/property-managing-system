 ...
 * @author junyaoli
 */
public class RenewalServiceJPanel extends javax.swing.JPanel {
    ...
    public RenewalServiceJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem business) {
         initComponents();
