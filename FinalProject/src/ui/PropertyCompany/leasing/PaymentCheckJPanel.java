 ...
 * @author junyaoli
 */
public class PaymentCheckJPanel extends javax.swing.JPanel {
    ...
    public PaymentCheckJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem business) {
         initComponents();
